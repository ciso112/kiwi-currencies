...
def get():
    if 'output_currency' in request.args:
        return create_json(sign_to_abbreviation(request.args['input_currency']),
                           sign_to_abbreviation(request.args['output_currency']),
                           request.args['amount'])
    else:
        return create_json(request.args['input_currency'],
                           "None", request.args['amount'])
